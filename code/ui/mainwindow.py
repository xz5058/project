...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_time.setGeometry(QtCore.QRect(850, 20, 0, 0))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bt_random_check.setText(_translate("MainWindow", "random call"))
        self.bt_supplement.setText(_translate("MainWindow", "Missing signature and supplementary signature"))
        self.label_location.setText(_translate("MainWindow", "Attendance location"))
        self.bt_blinks.setText(_translate("MainWindow", "Liveness detection"))
        self.bt_start_check.setText(_translate("MainWindow", "start attendance"))
        ...
        self.bt_generator.setText(_translate("MainWindow", "Train the model"))
        self.bt_load_model.setText(_translate("MainWindow", "load model"))
        self.bt_view.setText(_translate("MainWindow", "View Results"))
        self.label_lcdName2.setText(_translate("MainWindow", " actually arrive"))
        self.label_class.setText(_translate("MainWindow", "Attendance class"))
        self.bt_check_variation.setText(_translate("MainWindow", "Verify face database information"))
        self.label_listName2.setText(_translate("MainWindow", "be late"))
        self.bt_open_camera.setText(_translate("MainWindow", "turn on camera"))
        self.bt_leave.setText(_translate("MainWindow", "leave registration"))
        self.bt_check.setText(_translate("MainWindow", "Inquire"))
        self.label_location_2.setText(_translate("MainWindow", "Set attendance time"))
        self.bt_exit.setText(_translate("MainWindow", "Exit system"))
        ...
        self.label_listName1.setText(_translate("MainWindow", "didn't arrive"))
        self.bt_gathering.setText(_translate("MainWindow", "Information Collection"))
        self.label_lcdName1.setText(_translate("MainWindow", "Should go to"))
