...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.pb_success.setText(_translate("Form", "successful answer"))
        self.label.setText(_translate("Form", "name"))
        self.pb_fail.setText(_translate("Form", "Failed to answer"))
        self.label_id.setText(_translate("Form", "student ID"))
        self.pb_other.setText(_translate("Form", "else"))
        self.pb_start.setText(_translate("Form", "Start screening lucky viewers"))
        self.pb_connect_db.setText(_translate("Form", "Connect to the database"))
        self.pb_absence.setText(_translate("Form", "didn't arrive"))
